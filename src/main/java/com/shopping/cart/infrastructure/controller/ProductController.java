...
public class ProductController {
    ...
    @DeleteMapping("/{sku}")
    public ApiResponseDto deleteById(@PathVariable String sku) {
        return ApiResponseDto.builder()
                .data(productAppService.deleteById(sku))
                .build();
    }

    @PutMapping("/{sku}")
    public ApiResponseDto update(@PathVariable String sku, @RequestBody ProductDTO productDTO ){
        return ApiResponseDto.builder()
                .data(productAppService.updateById(sku,productDTO))
                .build();
    }
